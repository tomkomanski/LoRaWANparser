...
{
    public class NormalDailyPayload : Payload
    {
        ...
        private TimeStampVolume dailyReverseVolume = new();
        private TimeStampVolume dailyVolume = new();
        ...
        public TimeStampVolume DailyReverseVolume
        {
            get
            {
                return dailyReverseVolume;
            }
        }

        public TimeStampVolume DailyVolume
        {
            get
            {
                return dailyVolume;
        ...
        public void SetDailyReverseVolume(TimeStampVolume dailyReverseVolume)
        {
            this.dailyReverseVolume = dailyReverseVolume;
        }

        public void SetDailyVolume(TimeStampVolume dailyVolume)
        {
