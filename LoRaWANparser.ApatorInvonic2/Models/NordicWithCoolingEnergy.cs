...
{
    public class NordicWithCoolingEnergy : ParsedData
    {
        private DateTime timeStamp;
        private DateTime dateAndTimeOfPastPeriod;
        ...
        public DateTime DateAndTimeOfPastPeriod
        {
            get
            {
                return this.dateAndTimeOfPastPeriod;
            }
        }
        ...
        public void SetDateAndTimeOfPastPeriod(DateTime dateAndTimeOfPastPeriod)
        {
            this.dateAndTimeOfPastPeriod = dateAndTimeOfPastPeriod;
        }
